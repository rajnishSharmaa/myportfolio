...
<h1 className='py-4 px-4 font-bold text-white'>Project Ongoing</h1>
 ...
 <Card className="py-4">
    <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
     ...
     <small className="text-default-500 text-white">This is mobile app based on B2B. where business person can post their required services and sales person can bid on it to do that services. </small>
      <p className="font-bold text-large text-white">React JS Node JS MongoDB</p>
    </CardHeader>
  ...
  <Card className="py-4">
    <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
      ...
      <p className="font-bold text-large text-white">React JS</p>
    </CardHeader>
    {/* <CardBody className="overflow-visible py-2">
      <Image
        alt="Card background"
